...
def get_ensemble_result_on_test_and_fn(model_type, threshold, tag, test_and_fn_list = ['test', 'fn']):
    ...
    # center_threshold = {'3hit': 0.178, '2hit': 0.54, '1hit': 0.722}
    # retina_threshold = {'3hit': 0.1, '2hit': 0.3, '1hit': 0.976}
    # yolov4_threshold = {'3hit': 0.002, '2hit': 0.045, '1hit': 0.298}
    ...
    for test_and_fn, ground_truth_image_dir, ground_truth_label_dir, centernet2_label_dir, retinanet_label_dir, yolov4_label_dir in \
        ...
        ensemble_label_dir = os.path.join(ensemble_result_dir, 'ensemble_result_{}_{}'.format(model_type, tag), test_and_fn)
